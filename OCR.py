...
def process_pdf(pdf_path, out="bilan_actif_passif_sep.xlsx"):
    ...
    if pages_list is None:
        ...
        # Filtrer les pages pour ne pas dépasser le total
    ...
    for p in pages_list:
        ...
        for df in dfs:
            ...
            for _, row in df.iterrows():
                ...
                rubrique_raw, nums = extract_numeric_from_cells(cells, max_nums=4)
    ...
    print("Lignes Actif:", len(df_actif), " Lignes Passif:", len(df_passif))
    return out

# Pour exécution directe (optionnel)
